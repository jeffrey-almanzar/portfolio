            ...
            <div className="d-flex">
                <div className="col-lg-7">
                    <div className="hero-content">
                        ...
                        I'm a software engineer that loves bringing design to life. While working at RubyLaw, I've contributed to more than 8 live projects using React, Node and other technologies.    
                        </Text>
                        <div>
